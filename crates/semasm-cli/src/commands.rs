        ...
        match verify_candidate_semantics(&routine_object, &identity, &routine_symbol, &checked) {
            ...
            Err(error) => {
                ...
                let report = finalize_report(
                    ...
                    .with_findings(error.findings.to_vec()),
                    None,
                    None,
                    None,
                );
...
fn verify_candidate_semantics(
...
) -> Result<CandidateSemantics, SemanticGateError> {
    ...
    match (identity.isa, identity.abi, identity.object_format) {
        ...
        | (Isa::X86_64, Abi::WindowsX64, ObjectFormat::PeCoff) => {
            ...
            let findings = check_x86_abi_capability(
                &lowered,
                identity.abi,
                decode_coverage,
                lowering_coverage,
...
mod semantic_gate_tests {
    ...
    fn canonical_candidate_passes_static_semantic_gates() {
        ...
        let (gates, _alias, _region_access, _findings) =
