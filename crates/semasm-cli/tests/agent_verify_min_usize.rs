//! End-to-end agent verify for the pure-integer `min_usize` harness shape.
...
fn skip_if_incomplete(stderr: &str) -> bool {
    ...
    eprintln!("skipping min_usize agent verify e2e: {stderr}");
    true
}

#[test]
#[ignore = "requires nasm, ld, objdump, and qemu-user on PATH"]
fn agent_verify_min_usize_allow_execution_is_verified() {
